document.getElementById('calculateButton').addEventListener('click', function() {
    var prix1 = parseFloat(document.querySelector('input[placeholder="Prix unitaire 1"]').value) || 0;
    var quantite1 = parseFloat(document.querySelector('input[placeholder="Quantité 1"]').value) || 0;
    var resultat1 = prix1 * quantite1;
    document.querySelector('input[placeholder="Résultat 1"]').value = resultat1;

    var prix2 = parseFloat(document.querySelector('input[placeholder="Prix unitaire 2"]').value) || 0;
    var quantite2 = parseFloat(document.querySelector('input[placeholder="Quantité 2"]').value) || 0;
    var resultat2 = prix2 * quantite2;
    document.querySelector('input[placeholder="Résultat 2"]').value = resultat2;

    var prix3 = parseFloat(document.querySelector('input[placeholder="Prix unitaire 3"]').value) || 0;
    var quantite3 = parseFloat(document.querySelector('input[placeholder="Quantité 3"]').value) || 0;
